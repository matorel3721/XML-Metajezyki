...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"> 
        ...
        <html>
            ...
            <div class="jumbotron jumbotron-fluid">
                ...
                <div class="container">
                        ...
                        <form action="sort_cars.php" method="post">
                        <input type="submit" class="btn btn-light"  name="asc" value="A-Z"/>
                        <input type="submit" class="btn btn-light" style="margin-left: 20px;" name="desc" value="Z-A"/>
                        </form>
                </div>
                        ...
                        <table class="table table-light" style="margin-top: 30px; margin-left: -20%; font-size: 30px">
                            ...
                            <tbody>
                                ...
                                <xsl:sort select="*[name()=$sortedBy]" order="{$sort}"/>
                                    <tr align="center">
    ...
    <xsl:param name="sortedBy" select="'brand'"/>
